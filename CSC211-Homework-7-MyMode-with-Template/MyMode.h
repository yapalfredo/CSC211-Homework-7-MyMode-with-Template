...
template <class T>
MyMode<T>::MyMode(fstream& inFile)
{
	//CONSTRUCTOR
	initArray(inFile);
}
...
template <class T>
void MyMode<T>::initArray(fstream& inFile)
{
	string _input;
	//use stringstream to 
...
template <class T>
void MyMode<T>::printArray(fstream& outFile) const
{
...
template <class T>
const void MyMode<T>::lookForMode(fstream& outFile)
{
...
template <class T>
bool MyMode<T>::ifGreaterOrEqual(const T a, const T b, bool &greaterOrEqual)
{
...
template <class T>
bool MyMode<T>::ifExists(const T *tempArr, T val)
{
